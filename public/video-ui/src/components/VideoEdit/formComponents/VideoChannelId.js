...
export default class VideoChannelIdEdit extends React.Component {
  ...
  render () {
    ...
    return (
        <div className="form__row">
          <label className="form__label">YouTube Channel ID</label>
          <input { ...this.props.input} className={"form__field " + (hasError ? "form__field--error" : "")} type="text" value={this.props.video.data.metadata.channelId || ""} onChange={this.onUpdateChannelId} />
