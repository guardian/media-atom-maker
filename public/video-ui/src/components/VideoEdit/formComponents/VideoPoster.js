      ...
      return (
          <div className="form__row">
            ...
            <div className="form__imageselect">
              <GridImageSelect video={this.props.video} updateVideo={this.props.updateVideo} gridUrl={this.props.config.gridUrl} createPagePosterAdd={this.props.VideoCreate}/>
              {this.renderImage()}
            </div>
          </div>
      );
