...
export default class VideoPlutoAdd extends React.Component {
  ...
  renderDefaultOption() {
    return <option value="">Select pluto project id</option>;
  }
  ...
  render() {
    return (
      <div className="list-container">
        <select
          className="form__field form__field--select form__field--pluto"
          value={this.props.video.plutoProjectId}
          onChange={event => this.updatePlutoId(event)}
        >
