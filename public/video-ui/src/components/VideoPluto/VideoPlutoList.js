...
class VideoPlutoList extends React.Component {
  ...
  renderPlutoVideos() {
    ...
    return (
      <div className="empty-pluto-container">
        There are no videos without pluto ids in need of processing
      </div>
    );
  }
      ...
      return (
        <div>
          <div className="video__detail__page">
            <span className="video__detailbox__header">
              Videos without pluto projects
            </span>
          </div>
          <div>
...
function mapDispatchToProps(dispatch) {
  return {
    plutoVideoActions: bindActionCreators(
      Object.assign({}, getPlutoVideos, addProject),
      dispatch
    )
  };
}
