  ...
  offPlatform: [
    {
      ...
      title: 'YouTube',
      description:
        'Use on platform (non age-restricted content) and on YouTube',
      specifications: {
        positive: [
          'Manual play / pause',
          'Optional video page',
        ...
        negative: ['No share button', 'Age restrictions may apply'],
        info: ['Can be used on Fronts and Articles', 'Hosted on Youtube']
      }
    }
  ],
  selfHosted: [
    {
      ...
      title: 'Loop',
      description:
        'Short looping video – use for journalism (eg Breaking News)',
      specifications: {
        positive: [
          'Autoplays and loops',
          'Play / pause controls',
        ...
        info: ['Can be used on Fronts and Articles', 'Self-hosted']
      }
    },
    {
      id: 'Cinemagraph',
    ...
    },
    {
      ...
      title: 'Non-YouTube',
      description:
        'Use for on-platform self-hosted videos (i.e vertical ‘shorts’)',
      specifications: {
        positive: [
          'Autoplay on Fronts',
        ...
        negative: ['No share button', 'No support for livestreaming'],
        info: ['Can be used in Articles and Fronts', 'Self-hosted']
      }
    }
  ]
};
