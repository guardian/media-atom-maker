...
import {setS3UploadStatusToPostProcessing, resetS3UploadState, startVideoUpload, startPacFileUpload} from "../../slices/s3Upload";
...
function mapDispatchToProps(dispatch) {
  return {
    ...
    uploadActions: bindActionCreators(
      Object.assign({s3UploadPostProcessing: setS3UploadStatusToPostProcessing, s3UploadReset: resetS3UploadState, getUploads, startVideoUpload, startPacFileUpload}, s3UploadActions),
      dispatch
    ),
