import removeStringTagDuplicates from '../src/util/removeStringTagDuplicates';
...
describe('Removing string tag duplicates', () => {
  ...
  it('does not trim duplicates when matches do not exist', () => {
    ...
    expect(removeStringTagDuplicates(simpleTag, savedValue)).toEqual(savedValue);
  });
  ...
  it('trims multiple duplicates', () => {
    ...
    expect(removeStringTagDuplicates(tagWithLongName, savedValue)).toEqual(['this', 'was']);
  });
