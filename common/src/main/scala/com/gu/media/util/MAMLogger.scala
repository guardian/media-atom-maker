...
object MAMLogger extends Logging {
  ...
  def info(message: String, markers: Map[String, Any]): Unit = log.info(Markers.appendEntries(markers.asJava), message)
  def error(message: String, markers: Map[String, Any]): Unit = log.error(Markers.appendEntries(markers.asJava), message)
  def error(message: String, markers: Map[String, Any], throwable: Throwable): Unit = log.error(Markers.appendEntries(markers.asJava), message, throwable)
