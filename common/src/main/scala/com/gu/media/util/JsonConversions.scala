...
object JsonConversions {
  ...
  implicit val atomType: Writes[AtomType] =
    Writes[AtomType](at => JsString(at.name.toLowerCase))

  implicit val category: Writes[Category] =
    Writes[Category](category => JsString(category.name.toLowerCase))

  implicit val privacyStatusWrites: Writes[PrivacyStatus] =
    Writes[PrivacyStatus](ps => JsString(ps.name.toLowerCase))

  implicit val privacyStatusReads: Reads[PrivacyStatus] =
    Reads[PrivacyStatus](json => {
