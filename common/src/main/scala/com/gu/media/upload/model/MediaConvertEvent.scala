...
object MediaConvertEvent {
  implicit val format: Format[MediaConvertEvent] =
    Jsonx.formatCaseClass[MediaConvertEvent]
}

case class MediaConvertWarning(code: Int, count: Int)

object MediaConvertWarning {
  implicit val format: Format[MediaConvertWarning] =
    Jsonx.formatCaseClass[MediaConvertWarning]
}

case class MediaConvertStartEnd(start: Int, end: Int)

object MediaConvertStartEnd {
  implicit val format: Format[MediaConvertStartEnd] =
    Jsonx.formatCaseClass[MediaConvertStartEnd]
}
...
object MediaConvertEventDetail {
  implicit val format: Format[MediaConvertEventDetail] =
    Jsonx.formatCaseClass[MediaConvertEventDetail]
}
...
object MediaConvertOutputGroupDetails {
  implicit val format: Format[MediaConvertOutputGroupDetails] =
    Jsonx.formatCaseClass[MediaConvertOutputGroupDetails]
}
...
object MediaConvertVideoDetails {
  implicit val format: Format[MediaConvertVideoDetails] =
    Jsonx.formatCaseClass[MediaConvertVideoDetails]
}
...
object MediaConvertOutputDetails {
  implicit val format: Format[MediaConvertOutputDetails] =
    Jsonx.formatCaseClass[MediaConvertOutputDetails]
}
