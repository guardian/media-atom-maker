...
object BackfillDimensions extends App {
  ...
  println("- Export the Cookie request header to a MAM_COOKIE environment variable")
  println("- Export the Csrf-Token request header to a MAM_CSRF_TOKEN environment variable")
