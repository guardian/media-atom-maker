...
libraryDependencies ++= Seq(
  ...
  "com.gu"                     %% "atom-publisher-lib"           % "0.1.0-SNAPSHOT",
  "com.gu"                     %% "atom-publisher-lib"           % "0.1.0-SNAPSHOT" % "test" classifier "tests",
  "com.gu"                     %% "atom-manager-play"            % "0.1.0-SNAPSHOT",
  "com.gu"                     %% "atom-manager-play"            % "0.1.0-SNAPSHOT" % "test" classifier "tests",
